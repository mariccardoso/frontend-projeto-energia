      ...
      <div className={styles.conteudo}>
        <div className={styles.content}>
          ...
          <div className={styles.esquerda}>
            <h1>
              Descubra quanto{" "}
              <span className={styles.destaque}>sua casa consome</span> de
              energia
            </h1>
            <p>
              Simule o consumo elétrico dos cômodos da sua casa e veja onde você
              pode
              <strong> economizar até 40% na conta de luz</strong>. É rápido,
              interativo e gratuito.
            </p>
